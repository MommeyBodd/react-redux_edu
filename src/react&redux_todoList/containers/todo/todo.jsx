...
class ToDo extends Component {
  ...
  getActiveTasks = tasks => tasks.filter(task => !task.isCompleted).length
  ...
  render() {
    ...
    const taskCount = this.getActiveTasks(tasks)
    ...
    return (
      <div className="todo-wrapper">
        ...
        {isTasksExist && <Footer amount={taskCount} changeFilter={changeFilter} activeFilter={filters} />}
      </div>
    );
  }
}
